...
void testINA219(){
   ...
   sensor1.configure(INA219::VOLTAGE_RANGE::FSR_32, INA219::PGA_GAIN::GAIN_8_320MV, 1, 3);
   // sensor2.configure(INA219::VOLTAGE_RANGE::FSR_32, INA219::PGA_GAIN::GAIN_8_320MV, 1, 3);
   // sensor3.configure(INA219::VOLTAGE_RANGE::FSR_32, INA219::PGA_GAIN::GAIN_8_320MV, 1, 3);
   // sensor4.configure(INA219::VOLTAGE_RANGE::FSR_32, INA219::PGA_GAIN::GAIN_8_320MV, 1, 3);
   uint16_t value1 = sensor1.readRegister(INA219::REGISTERS::CONFIG);
